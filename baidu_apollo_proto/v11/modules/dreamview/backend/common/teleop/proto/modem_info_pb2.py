...
ModemInfo = _reflection.GeneratedProtocolMessageType('ModemInfo', (_message.Message,), {'DESCRIPTOR': _MODEMINFO, '__module__': 'modules.dreamview.backend.common.teleop.proto.modem_info_pb2'})
