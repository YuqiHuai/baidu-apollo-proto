...
DaemonCmd = _reflection.GeneratedProtocolMessageType('DaemonCmd', (_message.Message,), {'DESCRIPTOR': _DAEMONCMD, '__module__': 'modules.dreamview.backend.common.teleop.proto.daemon_cmd_pb2'})
