...
DaemonRpt = _reflection.GeneratedProtocolMessageType('DaemonRpt', (_message.Message,), {'DESCRIPTOR': _DAEMONRPT, '__module__': 'modules.dreamview.backend.common.teleop.proto.daemon_rpt_pb2'})
