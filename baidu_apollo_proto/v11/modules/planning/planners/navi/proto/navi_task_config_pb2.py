...
NaviObstacleDeciderConfig = _reflection.GeneratedProtocolMessageType('NaviObstacleDeciderConfig', (_message.Message,), {'DESCRIPTOR': _NAVIOBSTACLEDECIDERCONFIG, '__module__': 'modules.planning.planners.navi.proto.navi_task_config_pb2'})
_sym_db.RegisterMessage(NaviObstacleDeciderConfig)
NaviPathDeciderConfig = _reflection.GeneratedProtocolMessageType('NaviPathDeciderConfig', (_message.Message,), {'DESCRIPTOR': _NAVIPATHDECIDERCONFIG, '__module__': 'modules.planning.planners.navi.proto.navi_task_config_pb2'})
_sym_db.RegisterMessage(NaviPathDeciderConfig)
MoveDestLaneConfigTable = _reflection.GeneratedProtocolMessageType('MoveDestLaneConfigTable', (_message.Message,), {'DESCRIPTOR': _MOVEDESTLANECONFIGTABLE, '__module__': 'modules.planning.planners.navi.proto.navi_task_config_pb2'})
_sym_db.RegisterMessage(MoveDestLaneConfigTable)
ShiftConfig = _reflection.GeneratedProtocolMessageType('ShiftConfig', (_message.Message,), {'DESCRIPTOR': _SHIFTCONFIG, '__module__': 'modules.planning.planners.navi.proto.navi_task_config_pb2'})
_sym_db.RegisterMessage(ShiftConfig)
NaviSpeedDeciderConfig = _reflection.GeneratedProtocolMessageType('NaviSpeedDeciderConfig', (_message.Message,), {'DESCRIPTOR': _NAVISPEEDDECIDERCONFIG, '__module__': 'modules.planning.planners.navi.proto.navi_task_config_pb2'})
