...
OverlapFeature = _reflection.GeneratedProtocolMessageType('OverlapFeature', (_message.Message,), {'DESCRIPTOR': _OVERLAPFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(OverlapFeature)
PlanningTag = _reflection.GeneratedProtocolMessageType('PlanningTag', (_message.Message,), {'DESCRIPTOR': _PLANNINGTAG, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(PlanningTag)
ChassisFeature = _reflection.GeneratedProtocolMessageType('ChassisFeature', (_message.Message,), {'DESCRIPTOR': _CHASSISFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(ChassisFeature)
LocalizationFeature = _reflection.GeneratedProtocolMessageType('LocalizationFeature', (_message.Message,), {'DESCRIPTOR': _LOCALIZATIONFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(LocalizationFeature)
CommonPathPointFeature = _reflection.GeneratedProtocolMessageType('CommonPathPointFeature', (_message.Message,), {'DESCRIPTOR': _COMMONPATHPOINTFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(CommonPathPointFeature)
CommonTrajectoryPointFeature = _reflection.GeneratedProtocolMessageType('CommonTrajectoryPointFeature', (_message.Message,), {'DESCRIPTOR': _COMMONTRAJECTORYPOINTFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(CommonTrajectoryPointFeature)
TrajectoryPointFeature = _reflection.GeneratedProtocolMessageType('TrajectoryPointFeature', (_message.Message,), {'DESCRIPTOR': _TRAJECTORYPOINTFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(TrajectoryPointFeature)
PerceptionObstacleFeature = _reflection.GeneratedProtocolMessageType('PerceptionObstacleFeature', (_message.Message,), {'DESCRIPTOR': _PERCEPTIONOBSTACLEFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(PerceptionObstacleFeature)
ObstacleTrajectoryFeature = _reflection.GeneratedProtocolMessageType('ObstacleTrajectoryFeature', (_message.Message,), {'DESCRIPTOR': _OBSTACLETRAJECTORYFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(ObstacleTrajectoryFeature)
PredictionTrajectoryFeature = _reflection.GeneratedProtocolMessageType('PredictionTrajectoryFeature', (_message.Message,), {'DESCRIPTOR': _PREDICTIONTRAJECTORYFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(PredictionTrajectoryFeature)
PredictionObstacleFeature = _reflection.GeneratedProtocolMessageType('PredictionObstacleFeature', (_message.Message,), {'DESCRIPTOR': _PREDICTIONOBSTACLEFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(PredictionObstacleFeature)
ObstacleFeature = _reflection.GeneratedProtocolMessageType('ObstacleFeature', (_message.Message,), {'DESCRIPTOR': _OBSTACLEFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(ObstacleFeature)
RoutingResponseFeature = _reflection.GeneratedProtocolMessageType('RoutingResponseFeature', (_message.Message,), {'DESCRIPTOR': _ROUTINGRESPONSEFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(RoutingResponseFeature)
RoutingFeature = _reflection.GeneratedProtocolMessageType('RoutingFeature', (_message.Message,), {'DESCRIPTOR': _ROUTINGFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(RoutingFeature)
TrafficLightFeature = _reflection.GeneratedProtocolMessageType('TrafficLightFeature', (_message.Message,), {'DESCRIPTOR': _TRAFFICLIGHTFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(TrafficLightFeature)
TrafficLightDetectionFeature = _reflection.GeneratedProtocolMessageType('TrafficLightDetectionFeature', (_message.Message,), {'DESCRIPTOR': _TRAFFICLIGHTDETECTIONFEATURE, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(TrafficLightDetectionFeature)
ADCTrajectoryPoint = _reflection.GeneratedProtocolMessageType('ADCTrajectoryPoint', (_message.Message,), {'DESCRIPTOR': _ADCTRAJECTORYPOINT, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(ADCTrajectoryPoint)
LearningOutput = _reflection.GeneratedProtocolMessageType('LearningOutput', (_message.Message,), {'DESCRIPTOR': _LEARNINGOUTPUT, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(LearningOutput)
LearningDataFrame = _reflection.GeneratedProtocolMessageType('LearningDataFrame', (_message.Message,), {'DESCRIPTOR': _LEARNINGDATAFRAME, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(LearningDataFrame)
LearningData = _reflection.GeneratedProtocolMessageType('LearningData', (_message.Message,), {'DESCRIPTOR': _LEARNINGDATA, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
_sym_db.RegisterMessage(LearningData)
PlanningLearningData = _reflection.GeneratedProtocolMessageType('PlanningLearningData', (_message.Message,), {'DESCRIPTOR': _PLANNINGLEARNINGDATA, '__module__': 'modules.planning.planning_base.proto.learning_data_pb2'})
