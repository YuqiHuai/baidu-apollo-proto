...
PathPointRawFeature = _reflection.GeneratedProtocolMessageType('PathPointRawFeature', (_message.Message,), {'DESCRIPTOR': _PATHPOINTRAWFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'})
_sym_db.RegisterMessage(PathPointRawFeature)
SpeedPointRawFeature = _reflection.GeneratedProtocolMessageType('SpeedPointRawFeature', (_message.Message,), {'ObjectDecisionFeature': _reflection.GeneratedProtocolMessageType('ObjectDecisionFeature', (_message.Message,), {'DESCRIPTOR': _SPEEDPOINTRAWFEATURE_OBJECTDECISIONFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'}), 'DESCRIPTOR': _SPEEDPOINTRAWFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'})
_sym_db.RegisterMessage(SpeedPointRawFeature)
_sym_db.RegisterMessage(SpeedPointRawFeature.ObjectDecisionFeature)
ObstacleSTRawData = _reflection.GeneratedProtocolMessageType('ObstacleSTRawData', (_message.Message,), {'STPointPair': _reflection.GeneratedProtocolMessageType('STPointPair', (_message.Message,), {'DESCRIPTOR': _OBSTACLESTRAWDATA_STPOINTPAIR, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'}), 'ObstacleSTData': _reflection.GeneratedProtocolMessageType('ObstacleSTData', (_message.Message,), {'DESCRIPTOR': _OBSTACLESTRAWDATA_OBSTACLESTDATA, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'}), 'DESCRIPTOR': _OBSTACLESTRAWDATA, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'})
...
TrajectoryPointRawFeature = _reflection.GeneratedProtocolMessageType('TrajectoryPointRawFeature', (_message.Message,), {'DESCRIPTOR': _TRAJECTORYPOINTRAWFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'})
_sym_db.RegisterMessage(TrajectoryPointRawFeature)
TrajectoryRawFeature = _reflection.GeneratedProtocolMessageType('TrajectoryRawFeature', (_message.Message,), {'DESCRIPTOR': _TRAJECTORYRAWFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_raw_feature_pb2'})
