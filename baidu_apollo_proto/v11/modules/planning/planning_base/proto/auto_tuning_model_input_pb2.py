...
PathPointwiseFeature = _reflection.GeneratedProtocolMessageType('PathPointwiseFeature', (_message.Message,), {'ObstacleFeature': _reflection.GeneratedProtocolMessageType('ObstacleFeature', (_message.Message,), {'DESCRIPTOR': _PATHPOINTWISEFEATURE_OBSTACLEFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'}), 'BoundRelatedFeature': _reflection.GeneratedProtocolMessageType('BoundRelatedFeature', (_message.Message,), {'DESCRIPTOR': _PATHPOINTWISEFEATURE_BOUNDRELATEDFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'}), 'DESCRIPTOR': _PATHPOINTWISEFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'})
...
SpeedPointwiseFeature = _reflection.GeneratedProtocolMessageType('SpeedPointwiseFeature', (_message.Message,), {'ObstacleFeature': _reflection.GeneratedProtocolMessageType('ObstacleFeature', (_message.Message,), {'DESCRIPTOR': _SPEEDPOINTWISEFEATURE_OBSTACLEFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'}), 'DESCRIPTOR': _SPEEDPOINTWISEFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'})
_sym_db.RegisterMessage(SpeedPointwiseFeature)
_sym_db.RegisterMessage(SpeedPointwiseFeature.ObstacleFeature)
TrajectoryPointwiseFeature = _reflection.GeneratedProtocolMessageType('TrajectoryPointwiseFeature', (_message.Message,), {'DESCRIPTOR': _TRAJECTORYPOINTWISEFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'})
_sym_db.RegisterMessage(TrajectoryPointwiseFeature)
TrajectoryFeature = _reflection.GeneratedProtocolMessageType('TrajectoryFeature', (_message.Message,), {'DESCRIPTOR': _TRAJECTORYFEATURE, '__module__': 'modules.planning.planning_base.proto.auto_tuning_model_input_pb2'})
