...
QuadraticProgrammingProblem = _reflection.GeneratedProtocolMessageType('QuadraticProgrammingProblem', (_message.Message,), {'DESCRIPTOR': _QUADRATICPROGRAMMINGPROBLEM, '__module__': 'modules.planning.planning_base.proto.math.qp_problem_pb2'})
_sym_db.RegisterMessage(QuadraticProgrammingProblem)
QPMatrix = _reflection.GeneratedProtocolMessageType('QPMatrix', (_message.Message,), {'DESCRIPTOR': _QPMATRIX, '__module__': 'modules.planning.planning_base.proto.math.qp_problem_pb2'})
_sym_db.RegisterMessage(QPMatrix)
QuadraticProgrammingProblemSet = _reflection.GeneratedProtocolMessageType('QuadraticProgrammingProblemSet', (_message.Message,), {'DESCRIPTOR': _QUADRATICPROGRAMMINGPROBLEMSET, '__module__': 'modules.planning.planning_base.proto.math.qp_problem_pb2'})
