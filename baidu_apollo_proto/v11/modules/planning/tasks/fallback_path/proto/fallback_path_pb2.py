...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n>modules/planning/tasks/fallback_path/proto/fallback_path.proto\x12\x0fapollo.planning\x1aEmodules/planning/planning_base/proto/piecewise_jerk_path_config.proto"\xa2\x01\n\x12FallbackPathConfig\x12,\n$is_extend_lane_bounds_to_include_adc\x18\x01 \x01(\x08\x12\x15\n\rextend_buffer\x18\x02 \x01(\x01\x12G\n\x15path_optimizer_config\x18\x03 \x01(\x0b2(.apollo.planning.PiecewiseJerkPathConfig')
_FALLBACKPATHCONFIG = DESCRIPTOR.message_types_by_name['FallbackPathConfig']
FallbackPathConfig = _reflection.GeneratedProtocolMessageType('FallbackPathConfig', (_message.Message,), {'DESCRIPTOR': _FALLBACKPATHCONFIG, '__module__': 'modules.planning.tasks.fallback_path.proto.fallback_path_pb2'})
