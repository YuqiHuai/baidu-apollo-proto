...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n.modules/common_msgs/control_msgs/pad_msg.proto\x12\x0eapollo.control\x1a+modules/common_msgs/basic_msgs/header.proto"b\n\nPadMessage\x12%\n\x06header\x18\x01 \x01(\x0b2\x15.apollo.common.Header\x12-\n\x06action\x18\x02 \x01(\x0e2\x1d.apollo.control.DrivingAction*2\n\rDrivingAction\x12\t\n\x05START\x10\x01\x12\t\n\x05RESET\x10\x02\x12\x0b\n\x07VIN_REQ\x10\x03')
...
PadMessage = _reflection.GeneratedProtocolMessageType('PadMessage', (_message.Message,), {'DESCRIPTOR': _PADMESSAGE, '__module__': 'modules.common_msgs.control_msgs.pad_msg_pb2'})
