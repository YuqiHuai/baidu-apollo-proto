...
InputDebug = _reflection.GeneratedProtocolMessageType('InputDebug', (_message.Message,), {'DESCRIPTOR': _INPUTDEBUG, '__module__': 'modules.common_msgs.control_msgs.input_debug_pb2'})
