...
LaneLineCubicCurve = _reflection.GeneratedProtocolMessageType('LaneLineCubicCurve', (_message.Message,), {'DESCRIPTOR': _LANELINECUBICCURVE, '__module__': 'modules.common_msgs.perception_msgs.perception_camera_pb2'})
_sym_db.RegisterMessage(LaneLineCubicCurve)
EndPoints = _reflection.GeneratedProtocolMessageType('EndPoints', (_message.Message,), {'DESCRIPTOR': _ENDPOINTS, '__module__': 'modules.common_msgs.perception_msgs.perception_camera_pb2'})
_sym_db.RegisterMessage(EndPoints)
CameraLaneLine = _reflection.GeneratedProtocolMessageType('CameraLaneLine', (_message.Message,), {'DESCRIPTOR': _CAMERALANELINE, '__module__': 'modules.common_msgs.perception_msgs.perception_camera_pb2'})
_sym_db.RegisterMessage(CameraLaneLine)
CameraCalibrator = _reflection.GeneratedProtocolMessageType('CameraCalibrator', (_message.Message,), {'DESCRIPTOR': _CAMERACALIBRATOR, '__module__': 'modules.common_msgs.perception_msgs.perception_camera_pb2'})
_sym_db.RegisterMessage(CameraCalibrator)
CameraObstacle = _reflection.GeneratedProtocolMessageType('CameraObstacle', (_message.Message,), {'DESCRIPTOR': _CAMERAOBSTACLE, '__module__': 'modules.common_msgs.perception_msgs.perception_camera_pb2'})
_sym_db.RegisterMessage(CameraObstacle)
CameraDebug = _reflection.GeneratedProtocolMessageType('CameraDebug', (_message.Message,), {'DESCRIPTOR': _CAMERADEBUG, '__module__': 'modules.common_msgs.perception_msgs.perception_camera_pb2'})
