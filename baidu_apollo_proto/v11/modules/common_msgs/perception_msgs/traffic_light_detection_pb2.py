...
TrafficLightBox = _reflection.GeneratedProtocolMessageType('TrafficLightBox', (_message.Message,), {'DESCRIPTOR': _TRAFFICLIGHTBOX, '__module__': 'modules.common_msgs.perception_msgs.traffic_light_detection_pb2'})
_sym_db.RegisterMessage(TrafficLightBox)
TrafficLightDebug = _reflection.GeneratedProtocolMessageType('TrafficLightDebug', (_message.Message,), {'DESCRIPTOR': _TRAFFICLIGHTDEBUG, '__module__': 'modules.common_msgs.perception_msgs.traffic_light_detection_pb2'})
_sym_db.RegisterMessage(TrafficLightDebug)
TrafficLight = _reflection.GeneratedProtocolMessageType('TrafficLight', (_message.Message,), {'DESCRIPTOR': _TRAFFICLIGHT, '__module__': 'modules.common_msgs.perception_msgs.traffic_light_detection_pb2'})
_sym_db.RegisterMessage(TrafficLight)
TrafficLightDetection = _reflection.GeneratedProtocolMessageType('TrafficLightDetection', (_message.Message,), {'DESCRIPTOR': _TRAFFICLIGHTDETECTION, '__module__': 'modules.common_msgs.perception_msgs.traffic_light_detection_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TRAFFICLIGHTDETECTION._serialized_end = 1449
    _TRAFFICLIGHTDETECTION_CAMERAID._serialized_start = 1344
    _TRAFFICLIGHTDETECTION_CAMERAID._serialized_end = 1449