...
PerceptionLanes = _reflection.GeneratedProtocolMessageType('PerceptionLanes', (_message.Message,), {'DESCRIPTOR': _PERCEPTIONLANES, '__module__': 'modules.common_msgs.perception_msgs.perception_lane_pb2'})
