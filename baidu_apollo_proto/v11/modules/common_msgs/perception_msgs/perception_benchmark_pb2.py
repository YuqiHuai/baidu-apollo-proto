...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n>modules/common_msgs/perception_msgs/perception_benchmark.proto\x12\x11apollo.perception\x1a/modules/common_msgs/basic_msgs/error_code.proto\x1a+modules/common_msgs/basic_msgs/header.proto\x1a=modules/common_msgs/perception_msgs/perception_obstacle.proto"R\n\x0fSensorFrameInfo\x12\x11\n\tsensor_id\x18\x01 \x01(\t\x12\x11\n\ttimestamp\x18\x02 \x01(\x01\x12\x19\n\x11sensor2world_pose\x18\x03 \x03(\x01"\xf6\x01\n\x18PerceptionBenchmarkFrame\x12B\n\x13perception_obstacle\x18\x01 \x03(\x0b2%.apollo.perception.PerceptionObstacle\x12%\n\x06header\x18\x02 \x01(\x0b2\x15.apollo.common.Header\x120\n\nerror_code\x18\x03 \x01(\x0e2\x18.apollo.common.ErrorCode:\x02OK\x12=\n\x11sensor_frame_info\x18\x04 \x01(\x0b2".apollo.perception.SensorFrameInfo')
...
SensorFrameInfo = _reflection.GeneratedProtocolMessageType('SensorFrameInfo', (_message.Message,), {'DESCRIPTOR': _SENSORFRAMEINFO, '__module__': 'modules.common_msgs.perception_msgs.perception_benchmark_pb2'})
_sym_db.RegisterMessage(SensorFrameInfo)
PerceptionBenchmarkFrame = _reflection.GeneratedProtocolMessageType('PerceptionBenchmarkFrame', (_message.Message,), {'DESCRIPTOR': _PERCEPTIONBENCHMARKFRAME, '__module__': 'modules.common_msgs.perception_msgs.perception_benchmark_pb2'})
