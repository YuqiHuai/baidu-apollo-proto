...
Options = _reflection.GeneratedProtocolMessageType('Options', (_message.Message,), {'Axis': _reflection.GeneratedProtocolMessageType('Axis', (_message.Message,), {'DESCRIPTOR': _OPTIONS_AXIS, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'}), 'DESCRIPTOR': _OPTIONS, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'})
_sym_db.RegisterMessage(Options)
_sym_db.RegisterMessage(Options.Axis)
Line = _reflection.GeneratedProtocolMessageType('Line', (_message.Message,), {'PropertiesEntry': _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {'DESCRIPTOR': _LINE_PROPERTIESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'}), 'DESCRIPTOR': _LINE, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'})
_sym_db.RegisterMessage(Line)
_sym_db.RegisterMessage(Line.PropertiesEntry)
Polygon = _reflection.GeneratedProtocolMessageType('Polygon', (_message.Message,), {'PropertiesEntry': _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {'DESCRIPTOR': _POLYGON_PROPERTIESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'}), 'DESCRIPTOR': _POLYGON, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'})
_sym_db.RegisterMessage(Polygon)
_sym_db.RegisterMessage(Polygon.PropertiesEntry)
Car = _reflection.GeneratedProtocolMessageType('Car', (_message.Message,), {'DESCRIPTOR': _CAR, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'})
_sym_db.RegisterMessage(Car)
Chart = _reflection.GeneratedProtocolMessageType('Chart', (_message.Message,), {'DESCRIPTOR': _CHART, '__module__': 'modules.common_msgs.dreamview_msgs.chart_pb2'})
