...
PolygonPoint = _reflection.GeneratedProtocolMessageType('PolygonPoint', (_message.Message,), {'DESCRIPTOR': _POLYGONPOINT, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(PolygonPoint)
Prediction = _reflection.GeneratedProtocolMessageType('Prediction', (_message.Message,), {'DESCRIPTOR': _PREDICTION, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(Prediction)
Decision = _reflection.GeneratedProtocolMessageType('Decision', (_message.Message,), {'DESCRIPTOR': _DECISION, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(Decision)
Object = _reflection.GeneratedProtocolMessageType('Object', (_message.Message,), {'DESCRIPTOR': _OBJECT, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(Object)
DelaysInMs = _reflection.GeneratedProtocolMessageType('DelaysInMs', (_message.Message,), {'DESCRIPTOR': _DELAYSINMS, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(DelaysInMs)
RoutePath = _reflection.GeneratedProtocolMessageType('RoutePath', (_message.Message,), {'DESCRIPTOR': _ROUTEPATH, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(RoutePath)
Latency = _reflection.GeneratedProtocolMessageType('Latency', (_message.Message,), {'DESCRIPTOR': _LATENCY, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(Latency)
MapElementIds = _reflection.GeneratedProtocolMessageType('MapElementIds', (_message.Message,), {'DESCRIPTOR': _MAPELEMENTIDS, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(MapElementIds)
ControlData = _reflection.GeneratedProtocolMessageType('ControlData', (_message.Message,), {'DESCRIPTOR': _CONTROLDATA, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(ControlData)
Notification = _reflection.GeneratedProtocolMessageType('Notification', (_message.Message,), {'DESCRIPTOR': _NOTIFICATION, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(Notification)
SensorMeasurements = _reflection.GeneratedProtocolMessageType('SensorMeasurements', (_message.Message,), {'DESCRIPTOR': _SENSORMEASUREMENTS, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
_sym_db.RegisterMessage(SensorMeasurements)
SimulationWorld = _reflection.GeneratedProtocolMessageType('SimulationWorld', (_message.Message,), {'LatencyEntry': _reflection.GeneratedProtocolMessageType('LatencyEntry', (_message.Message,), {'DESCRIPTOR': _SIMULATIONWORLD_LATENCYENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'}), 'StoriesEntry': _reflection.GeneratedProtocolMessageType('StoriesEntry', (_message.Message,), {'DESCRIPTOR': _SIMULATIONWORLD_STORIESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'}), 'SensorMeasurementsEntry': _reflection.GeneratedProtocolMessageType('SensorMeasurementsEntry', (_message.Message,), {'DESCRIPTOR': _SIMULATIONWORLD_SENSORMEASUREMENTSENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'}), 'DESCRIPTOR': _SIMULATIONWORLD, '__module__': 'modules.common_msgs.dreamview_msgs.simulation_world_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MAPELEMENTIDS._serialized_end = 3708
    _CONTROLDATA._serialized_start = 3711
    _CONTROLDATA._serialized_end = 3878
    _NOTIFICATION._serialized_start = 3880
    _NOTIFICATION._serialized_end = 3974
    _SENSORMEASUREMENTS._serialized_start = 3976
    _SENSORMEASUREMENTS._serialized_end = 4050
    _SIMULATIONWORLD._serialized_start = 4053
    _SIMULATIONWORLD._serialized_end = 5684
    _SIMULATIONWORLD_LATENCYENTRY._serialized_start = 5466
    _SIMULATIONWORLD_LATENCYENTRY._serialized_end = 5539
    _SIMULATIONWORLD_STORIESENTRY._serialized_start = 5541
    _SIMULATIONWORLD_STORIESENTRY._serialized_end = 5587
    _SIMULATIONWORLD_SENSORMEASUREMENTSENTRY._serialized_start = 5589
    _SIMULATIONWORLD_SENSORMEASUREMENTSENTRY._serialized_end = 5684