...
ProcessMonitorConfig = _reflection.GeneratedProtocolMessageType('ProcessMonitorConfig', (_message.Message,), {'DESCRIPTOR': _PROCESSMONITORCONFIG, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
_sym_db.RegisterMessage(ProcessMonitorConfig)
ModuleMonitorConfig = _reflection.GeneratedProtocolMessageType('ModuleMonitorConfig', (_message.Message,), {'DESCRIPTOR': _MODULEMONITORCONFIG, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
_sym_db.RegisterMessage(ModuleMonitorConfig)
ChannelMonitorConfig = _reflection.GeneratedProtocolMessageType('ChannelMonitorConfig', (_message.Message,), {'DESCRIPTOR': _CHANNELMONITORCONFIG, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
_sym_db.RegisterMessage(ChannelMonitorConfig)
ResourceMonitorConfig = _reflection.GeneratedProtocolMessageType('ResourceMonitorConfig', (_message.Message,), {'DiskSpace': _reflection.GeneratedProtocolMessageType('DiskSpace', (_message.Message,), {'DESCRIPTOR': _RESOURCEMONITORCONFIG_DISKSPACE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'CPUUsage': _reflection.GeneratedProtocolMessageType('CPUUsage', (_message.Message,), {'DESCRIPTOR': _RESOURCEMONITORCONFIG_CPUUSAGE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'MemoryUsage': _reflection.GeneratedProtocolMessageType('MemoryUsage', (_message.Message,), {'DESCRIPTOR': _RESOURCEMONITORCONFIG_MEMORYUSAGE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'DiskLoad': _reflection.GeneratedProtocolMessageType('DiskLoad', (_message.Message,), {'DESCRIPTOR': _RESOURCEMONITORCONFIG_DISKLOAD, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'DESCRIPTOR': _RESOURCEMONITORCONFIG, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
...
MonitoredComponent = _reflection.GeneratedProtocolMessageType('MonitoredComponent', (_message.Message,), {'DESCRIPTOR': _MONITOREDCOMPONENT, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
_sym_db.RegisterMessage(MonitoredComponent)
Module = _reflection.GeneratedProtocolMessageType('Module', (_message.Message,), {'DESCRIPTOR': _MODULE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
_sym_db.RegisterMessage(Module)
CyberModule = _reflection.GeneratedProtocolMessageType('CyberModule', (_message.Message,), {'DESCRIPTOR': _CYBERMODULE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
_sym_db.RegisterMessage(CyberModule)
HMIMode = _reflection.GeneratedProtocolMessageType('HMIMode', (_message.Message,), {'CyberModulesEntry': _reflection.GeneratedProtocolMessageType('CyberModulesEntry', (_message.Message,), {'DESCRIPTOR': _HMIMODE_CYBERMODULESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'ModulesEntry': _reflection.GeneratedProtocolMessageType('ModulesEntry', (_message.Message,), {'DESCRIPTOR': _HMIMODE_MODULESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'MonitoredComponentsEntry': _reflection.GeneratedProtocolMessageType('MonitoredComponentsEntry', (_message.Message,), {'DESCRIPTOR': _HMIMODE_MONITOREDCOMPONENTSENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'OtherComponentsEntry': _reflection.GeneratedProtocolMessageType('OtherComponentsEntry', (_message.Message,), {'DESCRIPTOR': _HMIMODE_OTHERCOMPONENTSENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'GlobalComponentsEntry': _reflection.GeneratedProtocolMessageType('GlobalComponentsEntry', (_message.Message,), {'DESCRIPTOR': _HMIMODE_GLOBALCOMPONENTSENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'}), 'DESCRIPTOR': _HMIMODE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_mode_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _HMIMODE_GLOBALCOMPONENTSENTRY._serialized_options = b'8\x01'
