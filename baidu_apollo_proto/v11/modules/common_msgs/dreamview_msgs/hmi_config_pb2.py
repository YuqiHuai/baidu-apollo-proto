...
HMIConfig = _reflection.GeneratedProtocolMessageType('HMIConfig', (_message.Message,), {'ModesEntry': _reflection.GeneratedProtocolMessageType('ModesEntry', (_message.Message,), {'DESCRIPTOR': _HMICONFIG_MODESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_config_pb2'}), 'MapsEntry': _reflection.GeneratedProtocolMessageType('MapsEntry', (_message.Message,), {'DESCRIPTOR': _HMICONFIG_MAPSENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_config_pb2'}), 'VehiclesEntry': _reflection.GeneratedProtocolMessageType('VehiclesEntry', (_message.Message,), {'DESCRIPTOR': _HMICONFIG_VEHICLESENTRY, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_config_pb2'}), 'DESCRIPTOR': _HMICONFIG, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_config_pb2'})
...
VehicleData = _reflection.GeneratedProtocolMessageType('VehicleData', (_message.Message,), {'DataFile': _reflection.GeneratedProtocolMessageType('DataFile', (_message.Message,), {'DESCRIPTOR': _VEHICLEDATA_DATAFILE, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_config_pb2'}), 'DESCRIPTOR': _VEHICLEDATA, '__module__': 'modules.common_msgs.dreamview_msgs.hmi_config_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _HMIACTION._serialized_end = 1103
