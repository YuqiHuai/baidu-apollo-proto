...
AudioEvent = _reflection.GeneratedProtocolMessageType('AudioEvent', (_message.Message,), {'DESCRIPTOR': _AUDIOEVENT, '__module__': 'modules.common_msgs.audio_msgs.audio_event_pb2'})
