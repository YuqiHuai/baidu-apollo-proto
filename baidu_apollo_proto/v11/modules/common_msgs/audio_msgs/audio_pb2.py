...
AudioDetection = _reflection.GeneratedProtocolMessageType('AudioDetection', (_message.Message,), {'DESCRIPTOR': _AUDIODETECTION, '__module__': 'modules.common_msgs.audio_msgs.audio_pb2'})
