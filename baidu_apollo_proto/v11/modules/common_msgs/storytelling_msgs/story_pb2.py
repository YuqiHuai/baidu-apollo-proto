...
CloseToCrosswalk = _reflection.GeneratedProtocolMessageType('CloseToCrosswalk', (_message.Message,), {'DESCRIPTOR': _CLOSETOCROSSWALK, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
_sym_db.RegisterMessage(CloseToCrosswalk)
CloseToClearArea = _reflection.GeneratedProtocolMessageType('CloseToClearArea', (_message.Message,), {'DESCRIPTOR': _CLOSETOCLEARAREA, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
_sym_db.RegisterMessage(CloseToClearArea)
CloseToJunction = _reflection.GeneratedProtocolMessageType('CloseToJunction', (_message.Message,), {'DESCRIPTOR': _CLOSETOJUNCTION, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
_sym_db.RegisterMessage(CloseToJunction)
CloseToSignal = _reflection.GeneratedProtocolMessageType('CloseToSignal', (_message.Message,), {'DESCRIPTOR': _CLOSETOSIGNAL, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
_sym_db.RegisterMessage(CloseToSignal)
CloseToStopSign = _reflection.GeneratedProtocolMessageType('CloseToStopSign', (_message.Message,), {'DESCRIPTOR': _CLOSETOSTOPSIGN, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
_sym_db.RegisterMessage(CloseToStopSign)
CloseToYieldSign = _reflection.GeneratedProtocolMessageType('CloseToYieldSign', (_message.Message,), {'DESCRIPTOR': _CLOSETOYIELDSIGN, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
_sym_db.RegisterMessage(CloseToYieldSign)
Stories = _reflection.GeneratedProtocolMessageType('Stories', (_message.Message,), {'DESCRIPTOR': _STORIES, '__module__': 'modules.common_msgs.storytelling_msgs.story_pb2'})
