...
Uncertainty = _reflection.GeneratedProtocolMessageType('Uncertainty', (_message.Message,), {'DESCRIPTOR': _UNCERTAINTY, '__module__': 'modules.common_msgs.localization_msgs.localization_pb2'})
_sym_db.RegisterMessage(Uncertainty)
LocalizationEstimate = _reflection.GeneratedProtocolMessageType('LocalizationEstimate', (_message.Message,), {'DESCRIPTOR': _LOCALIZATIONESTIMATE, '__module__': 'modules.common_msgs.localization_msgs.localization_pb2'})
_sym_db.RegisterMessage(LocalizationEstimate)
LocalizationStatus = _reflection.GeneratedProtocolMessageType('LocalizationStatus', (_message.Message,), {'DESCRIPTOR': _LOCALIZATIONSTATUS, '__module__': 'modules.common_msgs.localization_msgs.localization_pb2'})
