...
CorrectedImu = _reflection.GeneratedProtocolMessageType('CorrectedImu', (_message.Message,), {'DESCRIPTOR': _CORRECTEDIMU, '__module__': 'modules.common_msgs.localization_msgs.imu_pb2'})
