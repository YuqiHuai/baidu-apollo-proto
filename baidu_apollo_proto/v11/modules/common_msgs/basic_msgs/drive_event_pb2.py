...
DriveEvent = _reflection.GeneratedProtocolMessageType('DriveEvent', (_message.Message,), {'DESCRIPTOR': _DRIVEEVENT, '__module__': 'modules.common_msgs.basic_msgs.drive_event_pb2'})
