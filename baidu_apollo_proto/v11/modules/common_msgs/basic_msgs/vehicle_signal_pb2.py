...
VehicleSignal = _reflection.GeneratedProtocolMessageType('VehicleSignal', (_message.Message,), {'DESCRIPTOR': _VEHICLESIGNAL, '__module__': 'modules.common_msgs.basic_msgs.vehicle_signal_pb2'})
