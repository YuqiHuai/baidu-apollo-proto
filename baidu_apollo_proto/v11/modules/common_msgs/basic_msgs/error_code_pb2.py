...
StatusPb = _reflection.GeneratedProtocolMessageType('StatusPb', (_message.Message,), {'DESCRIPTOR': _STATUSPB, '__module__': 'modules.common_msgs.basic_msgs.error_code_pb2'})
