...
PointENU = _reflection.GeneratedProtocolMessageType('PointENU', (_message.Message,), {'DESCRIPTOR': _POINTENU, '__module__': 'modules.common_msgs.basic_msgs.geometry_pb2'})
_sym_db.RegisterMessage(PointENU)
PointLLH = _reflection.GeneratedProtocolMessageType('PointLLH', (_message.Message,), {'DESCRIPTOR': _POINTLLH, '__module__': 'modules.common_msgs.basic_msgs.geometry_pb2'})
_sym_db.RegisterMessage(PointLLH)
Point2D = _reflection.GeneratedProtocolMessageType('Point2D', (_message.Message,), {'DESCRIPTOR': _POINT2D, '__module__': 'modules.common_msgs.basic_msgs.geometry_pb2'})
_sym_db.RegisterMessage(Point2D)
Point3D = _reflection.GeneratedProtocolMessageType('Point3D', (_message.Message,), {'DESCRIPTOR': _POINT3D, '__module__': 'modules.common_msgs.basic_msgs.geometry_pb2'})
_sym_db.RegisterMessage(Point3D)
Quaternion = _reflection.GeneratedProtocolMessageType('Quaternion', (_message.Message,), {'DESCRIPTOR': _QUATERNION, '__module__': 'modules.common_msgs.basic_msgs.geometry_pb2'})
_sym_db.RegisterMessage(Quaternion)
Polygon = _reflection.GeneratedProtocolMessageType('Polygon', (_message.Message,), {'DESCRIPTOR': _POLYGON, '__module__': 'modules.common_msgs.basic_msgs.geometry_pb2'})
