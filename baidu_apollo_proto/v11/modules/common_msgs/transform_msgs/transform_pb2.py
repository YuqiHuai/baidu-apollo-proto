...
Transform = _reflection.GeneratedProtocolMessageType('Transform', (_message.Message,), {'DESCRIPTOR': _TRANSFORM, '__module__': 'modules.common_msgs.transform_msgs.transform_pb2'})
_sym_db.RegisterMessage(Transform)
TransformStamped = _reflection.GeneratedProtocolMessageType('TransformStamped', (_message.Message,), {'DESCRIPTOR': _TRANSFORMSTAMPED, '__module__': 'modules.common_msgs.transform_msgs.transform_pb2'})
_sym_db.RegisterMessage(TransformStamped)
TransformStampeds = _reflection.GeneratedProtocolMessageType('TransformStampeds', (_message.Message,), {'DESCRIPTOR': _TRANSFORMSTAMPEDS, '__module__': 'modules.common_msgs.transform_msgs.transform_pb2'})
