...
BoundaryEdge = _reflection.GeneratedProtocolMessageType('BoundaryEdge', (_message.Message,), {'DESCRIPTOR': _BOUNDARYEDGE, '__module__': 'modules.common_msgs.map_msgs.map_road_pb2'})
_sym_db.RegisterMessage(BoundaryEdge)
BoundaryPolygon = _reflection.GeneratedProtocolMessageType('BoundaryPolygon', (_message.Message,), {'DESCRIPTOR': _BOUNDARYPOLYGON, '__module__': 'modules.common_msgs.map_msgs.map_road_pb2'})
_sym_db.RegisterMessage(BoundaryPolygon)
RoadBoundary = _reflection.GeneratedProtocolMessageType('RoadBoundary', (_message.Message,), {'DESCRIPTOR': _ROADBOUNDARY, '__module__': 'modules.common_msgs.map_msgs.map_road_pb2'})
_sym_db.RegisterMessage(RoadBoundary)
RoadROIBoundary = _reflection.GeneratedProtocolMessageType('RoadROIBoundary', (_message.Message,), {'DESCRIPTOR': _ROADROIBOUNDARY, '__module__': 'modules.common_msgs.map_msgs.map_road_pb2'})
_sym_db.RegisterMessage(RoadROIBoundary)
RoadSection = _reflection.GeneratedProtocolMessageType('RoadSection', (_message.Message,), {'DESCRIPTOR': _ROADSECTION, '__module__': 'modules.common_msgs.map_msgs.map_road_pb2'})
_sym_db.RegisterMessage(RoadSection)
Road = _reflection.GeneratedProtocolMessageType('Road', (_message.Message,), {'DESCRIPTOR': _ROAD, '__module__': 'modules.common_msgs.map_msgs.map_road_pb2'})
