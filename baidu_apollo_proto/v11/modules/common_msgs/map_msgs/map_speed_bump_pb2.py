...
SpeedBump = _reflection.GeneratedProtocolMessageType('SpeedBump', (_message.Message,), {'DESCRIPTOR': _SPEEDBUMP, '__module__': 'modules.common_msgs.map_msgs.map_speed_bump_pb2'})
