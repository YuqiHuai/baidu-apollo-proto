...
LaneBoundaryType = _reflection.GeneratedProtocolMessageType('LaneBoundaryType', (_message.Message,), {'DESCRIPTOR': _LANEBOUNDARYTYPE, '__module__': 'modules.common_msgs.map_msgs.map_lane_pb2'})
_sym_db.RegisterMessage(LaneBoundaryType)
LaneBoundary = _reflection.GeneratedProtocolMessageType('LaneBoundary', (_message.Message,), {'DESCRIPTOR': _LANEBOUNDARY, '__module__': 'modules.common_msgs.map_msgs.map_lane_pb2'})
_sym_db.RegisterMessage(LaneBoundary)
LaneSampleAssociation = _reflection.GeneratedProtocolMessageType('LaneSampleAssociation', (_message.Message,), {'DESCRIPTOR': _LANESAMPLEASSOCIATION, '__module__': 'modules.common_msgs.map_msgs.map_lane_pb2'})
_sym_db.RegisterMessage(LaneSampleAssociation)
Lane = _reflection.GeneratedProtocolMessageType('Lane', (_message.Message,), {'DESCRIPTOR': _LANE, '__module__': 'modules.common_msgs.map_msgs.map_lane_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _LANE._serialized_end = 1826
    _LANE_LANETYPE._serialized_start = 1594
    _LANE_LANETYPE._serialized_end = 1697
    _LANE_LANETURN._serialized_start = 1699
    _LANE_LANETURN._serialized_end = 1765
    _LANE_LANEDIRECTION._serialized_start = 1767
    _LANE_LANEDIRECTION._serialized_end = 1826