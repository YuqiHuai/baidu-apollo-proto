...
Passage = _reflection.GeneratedProtocolMessageType('Passage', (_message.Message,), {'DESCRIPTOR': _PASSAGE, '__module__': 'modules.common_msgs.map_msgs.map_pnc_junction_pb2'})
_sym_db.RegisterMessage(Passage)
PassageGroup = _reflection.GeneratedProtocolMessageType('PassageGroup', (_message.Message,), {'DESCRIPTOR': _PASSAGEGROUP, '__module__': 'modules.common_msgs.map_msgs.map_pnc_junction_pb2'})
_sym_db.RegisterMessage(PassageGroup)
PNCJunction = _reflection.GeneratedProtocolMessageType('PNCJunction', (_message.Message,), {'DESCRIPTOR': _PNCJUNCTION, '__module__': 'modules.common_msgs.map_msgs.map_pnc_junction_pb2'})
