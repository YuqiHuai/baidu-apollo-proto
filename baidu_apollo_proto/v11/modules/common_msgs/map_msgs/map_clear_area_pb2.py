...
ClearArea = _reflection.GeneratedProtocolMessageType('ClearArea', (_message.Message,), {'DESCRIPTOR': _CLEARAREA, '__module__': 'modules.common_msgs.map_msgs.map_clear_area_pb2'})
