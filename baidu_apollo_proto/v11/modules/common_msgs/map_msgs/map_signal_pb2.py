...
Subsignal = _reflection.GeneratedProtocolMessageType('Subsignal', (_message.Message,), {'DESCRIPTOR': _SUBSIGNAL, '__module__': 'modules.common_msgs.map_msgs.map_signal_pb2'})
_sym_db.RegisterMessage(Subsignal)
SignInfo = _reflection.GeneratedProtocolMessageType('SignInfo', (_message.Message,), {'DESCRIPTOR': _SIGNINFO, '__module__': 'modules.common_msgs.map_msgs.map_signal_pb2'})
_sym_db.RegisterMessage(SignInfo)
Signal = _reflection.GeneratedProtocolMessageType('Signal', (_message.Message,), {'DESCRIPTOR': _SIGNAL, '__module__': 'modules.common_msgs.map_msgs.map_signal_pb2'})
