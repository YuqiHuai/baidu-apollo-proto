...
Transform = _reflection.GeneratedProtocolMessageType('Transform', (_message.Message,), {'DESCRIPTOR': _TRANSFORM, '__module__': 'modules.common_msgs.config_msgs.vehicle_config_pb2'})
_sym_db.RegisterMessage(Transform)
Extrinsics = _reflection.GeneratedProtocolMessageType('Extrinsics', (_message.Message,), {'DESCRIPTOR': _EXTRINSICS, '__module__': 'modules.common_msgs.config_msgs.vehicle_config_pb2'})
_sym_db.RegisterMessage(Extrinsics)
LatencyParam = _reflection.GeneratedProtocolMessageType('LatencyParam', (_message.Message,), {'DESCRIPTOR': _LATENCYPARAM, '__module__': 'modules.common_msgs.config_msgs.vehicle_config_pb2'})
_sym_db.RegisterMessage(LatencyParam)
VehicleParam = _reflection.GeneratedProtocolMessageType('VehicleParam', (_message.Message,), {'DESCRIPTOR': _VEHICLEPARAM, '__module__': 'modules.common_msgs.config_msgs.vehicle_config_pb2'})
_sym_db.RegisterMessage(VehicleParam)
VehicleConfig = _reflection.GeneratedProtocolMessageType('VehicleConfig', (_message.Message,), {'DESCRIPTOR': _VEHICLECONFIG, '__module__': 'modules.common_msgs.config_msgs.vehicle_config_pb2'})
