...
ComponentStatus = _reflection.GeneratedProtocolMessageType('ComponentStatus', (_message.Message,), {'DESCRIPTOR': _COMPONENTSTATUS, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'})
_sym_db.RegisterMessage(ComponentStatus)
Component = _reflection.GeneratedProtocolMessageType('Component', (_message.Message,), {'DESCRIPTOR': _COMPONENT, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'})
_sym_db.RegisterMessage(Component)
SystemStatus = _reflection.GeneratedProtocolMessageType('SystemStatus', (_message.Message,), {'HmiModulesEntry': _reflection.GeneratedProtocolMessageType('HmiModulesEntry', (_message.Message,), {'DESCRIPTOR': _SYSTEMSTATUS_HMIMODULESENTRY, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'}), 'ComponentsEntry': _reflection.GeneratedProtocolMessageType('ComponentsEntry', (_message.Message,), {'DESCRIPTOR': _SYSTEMSTATUS_COMPONENTSENTRY, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'}), 'OtherComponentsEntry': _reflection.GeneratedProtocolMessageType('OtherComponentsEntry', (_message.Message,), {'DESCRIPTOR': _SYSTEMSTATUS_OTHERCOMPONENTSENTRY, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'}), 'GlobalComponentsEntry': _reflection.GeneratedProtocolMessageType('GlobalComponentsEntry', (_message.Message,), {'DESCRIPTOR': _SYSTEMSTATUS_GLOBALCOMPONENTSENTRY, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'}), 'DESCRIPTOR': _SYSTEMSTATUS, '__module__': 'modules.common_msgs.monitor_msgs.system_status_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SYSTEMSTATUS_GLOBALCOMPONENTSENTRY._serialized_options = b'8\x01'
