...
MonitorMessageItem = _reflection.GeneratedProtocolMessageType('MonitorMessageItem', (_message.Message,), {'DESCRIPTOR': _MONITORMESSAGEITEM, '__module__': 'modules.common_msgs.monitor_msgs.monitor_log_pb2'})
_sym_db.RegisterMessage(MonitorMessageItem)
MonitorMessage = _reflection.GeneratedProtocolMessageType('MonitorMessage', (_message.Message,), {'DESCRIPTOR': _MONITORMESSAGE, '__module__': 'modules.common_msgs.monitor_msgs.monitor_log_pb2'})
_sym_db.RegisterMessage(MonitorMessage)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _MONITORMESSAGEITEM._serialized_start = 123
    _MONITORMESSAGEITEM._serialized_end = 716
    _MONITORMESSAGEITEM_MESSAGESOURCE._serialized_start = 318
    _MONITORMESSAGEITEM_MESSAGESOURCE._serialized_end = 662
    _MONITORMESSAGEITEM_LOGLEVEL._serialized_start = 664
    _MONITORMESSAGEITEM_LOGLEVEL._serialized_end = 716
    _MONITORMESSAGE._serialized_start = 718
    _MONITORMESSAGE._serialized_end = 830