...
NavigationPath = _reflection.GeneratedProtocolMessageType('NavigationPath', (_message.Message,), {'DESCRIPTOR': _NAVIGATIONPATH, '__module__': 'modules.common_msgs.planning_msgs.navigation_pb2'})
_sym_db.RegisterMessage(NavigationPath)
NavigationInfo = _reflection.GeneratedProtocolMessageType('NavigationInfo', (_message.Message,), {'DESCRIPTOR': _NAVIGATIONINFO, '__module__': 'modules.common_msgs.planning_msgs.navigation_pb2'})
_sym_db.RegisterMessage(NavigationInfo)
MapMsg = _reflection.GeneratedProtocolMessageType('MapMsg', (_message.Message,), {'NavigationPathEntry': _reflection.GeneratedProtocolMessageType('NavigationPathEntry', (_message.Message,), {'DESCRIPTOR': _MAPMSG_NAVIGATIONPATHENTRY, '__module__': 'modules.common_msgs.planning_msgs.navigation_pb2'}), 'DESCRIPTOR': _MAPMSG, '__module__': 'modules.common_msgs.planning_msgs.navigation_pb2'})
