...
TargetLane = _reflection.GeneratedProtocolMessageType('TargetLane', (_message.Message,), {'DESCRIPTOR': _TARGETLANE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(TargetLane)
ObjectIgnore = _reflection.GeneratedProtocolMessageType('ObjectIgnore', (_message.Message,), {'DESCRIPTOR': _OBJECTIGNORE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectIgnore)
ObjectStop = _reflection.GeneratedProtocolMessageType('ObjectStop', (_message.Message,), {'DESCRIPTOR': _OBJECTSTOP, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectStop)
ObjectNudge = _reflection.GeneratedProtocolMessageType('ObjectNudge', (_message.Message,), {'DESCRIPTOR': _OBJECTNUDGE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectNudge)
ObjectYield = _reflection.GeneratedProtocolMessageType('ObjectYield', (_message.Message,), {'DESCRIPTOR': _OBJECTYIELD, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectYield)
ObjectFollow = _reflection.GeneratedProtocolMessageType('ObjectFollow', (_message.Message,), {'DESCRIPTOR': _OBJECTFOLLOW, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectFollow)
ObjectOvertake = _reflection.GeneratedProtocolMessageType('ObjectOvertake', (_message.Message,), {'DESCRIPTOR': _OBJECTOVERTAKE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectOvertake)
ObjectSidePass = _reflection.GeneratedProtocolMessageType('ObjectSidePass', (_message.Message,), {'DESCRIPTOR': _OBJECTSIDEPASS, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectSidePass)
ObjectAvoid = _reflection.GeneratedProtocolMessageType('ObjectAvoid', (_message.Message,), {'DESCRIPTOR': _OBJECTAVOID, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectAvoid)
ObjectStatus = _reflection.GeneratedProtocolMessageType('ObjectStatus', (_message.Message,), {'DESCRIPTOR': _OBJECTSTATUS, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectStatus)
ObjectStatic = _reflection.GeneratedProtocolMessageType('ObjectStatic', (_message.Message,), {'DESCRIPTOR': _OBJECTSTATIC, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectStatic)
ObjectDynamic = _reflection.GeneratedProtocolMessageType('ObjectDynamic', (_message.Message,), {'DESCRIPTOR': _OBJECTDYNAMIC, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectDynamic)
ObjectMotionType = _reflection.GeneratedProtocolMessageType('ObjectMotionType', (_message.Message,), {'DESCRIPTOR': _OBJECTMOTIONTYPE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectMotionType)
ObjectDecisionType = _reflection.GeneratedProtocolMessageType('ObjectDecisionType', (_message.Message,), {'DESCRIPTOR': _OBJECTDECISIONTYPE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectDecisionType)
ObjectDecision = _reflection.GeneratedProtocolMessageType('ObjectDecision', (_message.Message,), {'DESCRIPTOR': _OBJECTDECISION, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectDecision)
ObjectDecisions = _reflection.GeneratedProtocolMessageType('ObjectDecisions', (_message.Message,), {'DESCRIPTOR': _OBJECTDECISIONS, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(ObjectDecisions)
MainStop = _reflection.GeneratedProtocolMessageType('MainStop', (_message.Message,), {'DESCRIPTOR': _MAINSTOP, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainStop)
EmergencyStopHardBrake = _reflection.GeneratedProtocolMessageType('EmergencyStopHardBrake', (_message.Message,), {'DESCRIPTOR': _EMERGENCYSTOPHARDBRAKE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(EmergencyStopHardBrake)
EmergencyStopCruiseToStop = _reflection.GeneratedProtocolMessageType('EmergencyStopCruiseToStop', (_message.Message,), {'DESCRIPTOR': _EMERGENCYSTOPCRUISETOSTOP, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(EmergencyStopCruiseToStop)
MainEmergencyStop = _reflection.GeneratedProtocolMessageType('MainEmergencyStop', (_message.Message,), {'DESCRIPTOR': _MAINEMERGENCYSTOP, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainEmergencyStop)
MainCruise = _reflection.GeneratedProtocolMessageType('MainCruise', (_message.Message,), {'DESCRIPTOR': _MAINCRUISE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainCruise)
MainChangeLane = _reflection.GeneratedProtocolMessageType('MainChangeLane', (_message.Message,), {'DESCRIPTOR': _MAINCHANGELANE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainChangeLane)
MainMissionComplete = _reflection.GeneratedProtocolMessageType('MainMissionComplete', (_message.Message,), {'DESCRIPTOR': _MAINMISSIONCOMPLETE, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainMissionComplete)
MainNotReady = _reflection.GeneratedProtocolMessageType('MainNotReady', (_message.Message,), {'DESCRIPTOR': _MAINNOTREADY, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainNotReady)
MainParking = _reflection.GeneratedProtocolMessageType('MainParking', (_message.Message,), {'DESCRIPTOR': _MAINPARKING, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainParking)
MainDecision = _reflection.GeneratedProtocolMessageType('MainDecision', (_message.Message,), {'DESCRIPTOR': _MAINDECISION, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
_sym_db.RegisterMessage(MainDecision)
DecisionResult = _reflection.GeneratedProtocolMessageType('DecisionResult', (_message.Message,), {'DESCRIPTOR': _DECISIONRESULT, '__module__': 'modules.common_msgs.planning_msgs.decision_pb2'})
