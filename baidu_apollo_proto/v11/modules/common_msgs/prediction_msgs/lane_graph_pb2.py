...
LanePoint = _reflection.GeneratedProtocolMessageType('LanePoint', (_message.Message,), {'DESCRIPTOR': _LANEPOINT, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
_sym_db.RegisterMessage(LanePoint)
LaneSegment = _reflection.GeneratedProtocolMessageType('LaneSegment', (_message.Message,), {'DESCRIPTOR': _LANESEGMENT, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
_sym_db.RegisterMessage(LaneSegment)
NearbyObstacle = _reflection.GeneratedProtocolMessageType('NearbyObstacle', (_message.Message,), {'DESCRIPTOR': _NEARBYOBSTACLE, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
_sym_db.RegisterMessage(NearbyObstacle)
StopSign = _reflection.GeneratedProtocolMessageType('StopSign', (_message.Message,), {'DESCRIPTOR': _STOPSIGN, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
_sym_db.RegisterMessage(StopSign)
LaneSequence = _reflection.GeneratedProtocolMessageType('LaneSequence', (_message.Message,), {'Features': _reflection.GeneratedProtocolMessageType('Features', (_message.Message,), {'DESCRIPTOR': _LANESEQUENCE_FEATURES, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'}), 'DESCRIPTOR': _LANESEQUENCE, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
_sym_db.RegisterMessage(LaneSequence)
_sym_db.RegisterMessage(LaneSequence.Features)
LaneGraph = _reflection.GeneratedProtocolMessageType('LaneGraph', (_message.Message,), {'DESCRIPTOR': _LANEGRAPH, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
_sym_db.RegisterMessage(LaneGraph)
LaneObstacle = _reflection.GeneratedProtocolMessageType('LaneObstacle', (_message.Message,), {'DESCRIPTOR': _LANEOBSTACLE, '__module__': 'modules.common_msgs.prediction_msgs.lane_graph_pb2'})
