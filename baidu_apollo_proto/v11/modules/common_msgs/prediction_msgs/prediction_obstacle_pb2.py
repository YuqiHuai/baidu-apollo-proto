...
ObstacleIntent = _reflection.GeneratedProtocolMessageType('ObstacleIntent', (_message.Message,), {'DESCRIPTOR': _OBSTACLEINTENT, '__module__': 'modules.common_msgs.prediction_msgs.prediction_obstacle_pb2'})
_sym_db.RegisterMessage(ObstacleIntent)
Intent = _reflection.GeneratedProtocolMessageType('Intent', (_message.Message,), {'DESCRIPTOR': _INTENT, '__module__': 'modules.common_msgs.prediction_msgs.prediction_obstacle_pb2'})
_sym_db.RegisterMessage(Intent)
PredictionObstacle = _reflection.GeneratedProtocolMessageType('PredictionObstacle', (_message.Message,), {'DESCRIPTOR': _PREDICTIONOBSTACLE, '__module__': 'modules.common_msgs.prediction_msgs.prediction_obstacle_pb2'})
_sym_db.RegisterMessage(PredictionObstacle)
PredictionObstacles = _reflection.GeneratedProtocolMessageType('PredictionObstacles', (_message.Message,), {'DESCRIPTOR': _PREDICTIONOBSTACLES, '__module__': 'modules.common_msgs.prediction_msgs.prediction_obstacle_pb2'})
