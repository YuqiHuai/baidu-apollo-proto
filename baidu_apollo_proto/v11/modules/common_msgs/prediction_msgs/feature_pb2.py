...
Lane = _reflection.GeneratedProtocolMessageType('Lane', (_message.Message,), {'DESCRIPTOR': _LANE, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(Lane)
LaneFeature = _reflection.GeneratedProtocolMessageType('LaneFeature', (_message.Message,), {'DESCRIPTOR': _LANEFEATURE, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(LaneFeature)
JunctionExit = _reflection.GeneratedProtocolMessageType('JunctionExit', (_message.Message,), {'DESCRIPTOR': _JUNCTIONEXIT, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(JunctionExit)
JunctionFeature = _reflection.GeneratedProtocolMessageType('JunctionFeature', (_message.Message,), {'DESCRIPTOR': _JUNCTIONFEATURE, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(JunctionFeature)
ObstaclePriority = _reflection.GeneratedProtocolMessageType('ObstaclePriority', (_message.Message,), {'DESCRIPTOR': _OBSTACLEPRIORITY, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(ObstaclePriority)
ObstacleInteractiveTag = _reflection.GeneratedProtocolMessageType('ObstacleInteractiveTag', (_message.Message,), {'DESCRIPTOR': _OBSTACLEINTERACTIVETAG, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(ObstacleInteractiveTag)
Trajectory = _reflection.GeneratedProtocolMessageType('Trajectory', (_message.Message,), {'DESCRIPTOR': _TRAJECTORY, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(Trajectory)
Feature = _reflection.GeneratedProtocolMessageType('Feature', (_message.Message,), {'DESCRIPTOR': _FEATURE, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(Feature)
ObstacleHistory = _reflection.GeneratedProtocolMessageType('ObstacleHistory', (_message.Message,), {'DESCRIPTOR': _OBSTACLEHISTORY, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
_sym_db.RegisterMessage(ObstacleHistory)
FrameEnv = _reflection.GeneratedProtocolMessageType('FrameEnv', (_message.Message,), {'DESCRIPTOR': _FRAMEENV, '__module__': 'modules.common_msgs.prediction_msgs.feature_pb2'})
