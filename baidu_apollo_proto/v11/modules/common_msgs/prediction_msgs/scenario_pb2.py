...
Scenario = _reflection.GeneratedProtocolMessageType('Scenario', (_message.Message,), {'DESCRIPTOR': _SCENARIO, '__module__': 'modules.common_msgs.prediction_msgs.scenario_pb2'})
