...
RacobitClusterListStatus_600 = _reflection.GeneratedProtocolMessageType('RacobitClusterListStatus_600', (_message.Message,), {'DESCRIPTOR': _RACOBITCLUSTERLISTSTATUS_600, '__module__': 'modules.common_msgs.sensor_msgs.racobit_radar_pb2'})
_sym_db.RegisterMessage(RacobitClusterListStatus_600)
RacobitObjectListStatus_60A = _reflection.GeneratedProtocolMessageType('RacobitObjectListStatus_60A', (_message.Message,), {'DESCRIPTOR': _RACOBITOBJECTLISTSTATUS_60A, '__module__': 'modules.common_msgs.sensor_msgs.racobit_radar_pb2'})
_sym_db.RegisterMessage(RacobitObjectListStatus_60A)
RacobitRadarState_201 = _reflection.GeneratedProtocolMessageType('RacobitRadarState_201', (_message.Message,), {'DESCRIPTOR': _RACOBITRADARSTATE_201, '__module__': 'modules.common_msgs.sensor_msgs.racobit_radar_pb2'})
_sym_db.RegisterMessage(RacobitRadarState_201)
RacobitRadarObs = _reflection.GeneratedProtocolMessageType('RacobitRadarObs', (_message.Message,), {'DESCRIPTOR': _RACOBITRADAROBS, '__module__': 'modules.common_msgs.sensor_msgs.racobit_radar_pb2'})
_sym_db.RegisterMessage(RacobitRadarObs)
RacobitRadar = _reflection.GeneratedProtocolMessageType('RacobitRadar', (_message.Message,), {'DESCRIPTOR': _RACOBITRADAR, '__module__': 'modules.common_msgs.sensor_msgs.racobit_radar_pb2'})
