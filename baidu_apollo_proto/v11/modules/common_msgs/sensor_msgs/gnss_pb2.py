...
Gnss = _reflection.GeneratedProtocolMessageType('Gnss', (_message.Message,), {'DESCRIPTOR': _GNSS, '__module__': 'modules.common_msgs.sensor_msgs.gnss_pb2'})
_sym_db.RegisterMessage(Gnss)
RawData = _reflection.GeneratedProtocolMessageType('RawData', (_message.Message,), {'DESCRIPTOR': _RAWDATA, '__module__': 'modules.common_msgs.sensor_msgs.gnss_pb2'})
