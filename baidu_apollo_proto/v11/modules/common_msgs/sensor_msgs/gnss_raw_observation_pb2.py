...
BandObservation = _reflection.GeneratedProtocolMessageType('BandObservation', (_message.Message,), {'DESCRIPTOR': _BANDOBSERVATION, '__module__': 'modules.common_msgs.sensor_msgs.gnss_raw_observation_pb2'})
_sym_db.RegisterMessage(BandObservation)
SatelliteObservation = _reflection.GeneratedProtocolMessageType('SatelliteObservation', (_message.Message,), {'DESCRIPTOR': _SATELLITEOBSERVATION, '__module__': 'modules.common_msgs.sensor_msgs.gnss_raw_observation_pb2'})
_sym_db.RegisterMessage(SatelliteObservation)
EpochObservation = _reflection.GeneratedProtocolMessageType('EpochObservation', (_message.Message,), {'DESCRIPTOR': _EPOCHOBSERVATION, '__module__': 'modules.common_msgs.sensor_msgs.gnss_raw_observation_pb2'})
_sym_db.RegisterMessage(EpochObservation)
KepplerOrbit = _reflection.GeneratedProtocolMessageType('KepplerOrbit', (_message.Message,), {'DESCRIPTOR': _KEPPLERORBIT, '__module__': 'modules.common_msgs.sensor_msgs.gnss_raw_observation_pb2'})
_sym_db.RegisterMessage(KepplerOrbit)
GlonassOrbit = _reflection.GeneratedProtocolMessageType('GlonassOrbit', (_message.Message,), {'DESCRIPTOR': _GLONASSORBIT, '__module__': 'modules.common_msgs.sensor_msgs.gnss_raw_observation_pb2'})
_sym_db.RegisterMessage(GlonassOrbit)
GnssEphemeris = _reflection.GeneratedProtocolMessageType('GnssEphemeris', (_message.Message,), {'DESCRIPTOR': _GNSSEPHEMERIS, '__module__': 'modules.common_msgs.sensor_msgs.gnss_raw_observation_pb2'})
