...
Ultrasonic = _reflection.GeneratedProtocolMessageType('Ultrasonic', (_message.Message,), {'DESCRIPTOR': _ULTRASONIC, '__module__': 'modules.common_msgs.sensor_msgs.ultrasonic_radar_pb2'})
