...
GnssBestPose = _reflection.GeneratedProtocolMessageType('GnssBestPose', (_message.Message,), {'DESCRIPTOR': _GNSSBESTPOSE, '__module__': 'modules.common_msgs.sensor_msgs.gnss_best_pose_pb2'})
