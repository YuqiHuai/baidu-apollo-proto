...
PointXYZIT = _reflection.GeneratedProtocolMessageType('PointXYZIT', (_message.Message,), {'DESCRIPTOR': _POINTXYZIT, '__module__': 'modules.common_msgs.sensor_msgs.pointcloud_pb2'})
_sym_db.RegisterMessage(PointXYZIT)
PointCloud = _reflection.GeneratedProtocolMessageType('PointCloud', (_message.Message,), {'DESCRIPTOR': _POINTCLOUD, '__module__': 'modules.common_msgs.sensor_msgs.pointcloud_pb2'})
