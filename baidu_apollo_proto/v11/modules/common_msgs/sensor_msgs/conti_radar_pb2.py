...
ClusterListStatus_600 = _reflection.GeneratedProtocolMessageType('ClusterListStatus_600', (_message.Message,), {'DESCRIPTOR': _CLUSTERLISTSTATUS_600, '__module__': 'modules.common_msgs.sensor_msgs.conti_radar_pb2'})
_sym_db.RegisterMessage(ClusterListStatus_600)
ObjectListStatus_60A = _reflection.GeneratedProtocolMessageType('ObjectListStatus_60A', (_message.Message,), {'DESCRIPTOR': _OBJECTLISTSTATUS_60A, '__module__': 'modules.common_msgs.sensor_msgs.conti_radar_pb2'})
_sym_db.RegisterMessage(ObjectListStatus_60A)
RadarState_201 = _reflection.GeneratedProtocolMessageType('RadarState_201', (_message.Message,), {'DESCRIPTOR': _RADARSTATE_201, '__module__': 'modules.common_msgs.sensor_msgs.conti_radar_pb2'})
_sym_db.RegisterMessage(RadarState_201)
ContiRadarObs = _reflection.GeneratedProtocolMessageType('ContiRadarObs', (_message.Message,), {'DESCRIPTOR': _CONTIRADAROBS, '__module__': 'modules.common_msgs.sensor_msgs.conti_radar_pb2'})
_sym_db.RegisterMessage(ContiRadarObs)
ContiRadar = _reflection.GeneratedProtocolMessageType('ContiRadar', (_message.Message,), {'DESCRIPTOR': _CONTIRADAR, '__module__': 'modules.common_msgs.sensor_msgs.conti_radar_pb2'})
