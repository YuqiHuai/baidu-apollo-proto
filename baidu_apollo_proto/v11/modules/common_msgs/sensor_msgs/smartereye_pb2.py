...
LdwLaneBoundary = _reflection.GeneratedProtocolMessageType('LdwLaneBoundary', (_message.Message,), {'DESCRIPTOR': _LDWLANEBOUNDARY, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(LdwLaneBoundary)
LdwLane = _reflection.GeneratedProtocolMessageType('LdwLane', (_message.Message,), {'DESCRIPTOR': _LDWLANE, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(LdwLane)
LdwRoadway = _reflection.GeneratedProtocolMessageType('LdwRoadway', (_message.Message,), {'DESCRIPTOR': _LDWROADWAY, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(LdwRoadway)
LdwLensInfo = _reflection.GeneratedProtocolMessageType('LdwLensInfo', (_message.Message,), {'DESCRIPTOR': _LDWLENSINFO, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(LdwLensInfo)
LdwDataPacks = _reflection.GeneratedProtocolMessageType('LdwDataPacks', (_message.Message,), {'DESCRIPTOR': _LDWDATAPACKS, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(LdwDataPacks)
OutputObstacle = _reflection.GeneratedProtocolMessageType('OutputObstacle', (_message.Message,), {'DESCRIPTOR': _OUTPUTOBSTACLE, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(OutputObstacle)
SmartereyeObstacles = _reflection.GeneratedProtocolMessageType('SmartereyeObstacles', (_message.Message,), {'OutputObstaclesEntry': _reflection.GeneratedProtocolMessageType('OutputObstaclesEntry', (_message.Message,), {'DESCRIPTOR': _SMARTEREYEOBSTACLES_OUTPUTOBSTACLESENTRY, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'}), 'DESCRIPTOR': _SMARTEREYEOBSTACLES, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
_sym_db.RegisterMessage(SmartereyeObstacles)
_sym_db.RegisterMessage(SmartereyeObstacles.OutputObstaclesEntry)
SmartereyeLanemark = _reflection.GeneratedProtocolMessageType('SmartereyeLanemark', (_message.Message,), {'DESCRIPTOR': _SMARTEREYELANEMARK, '__module__': 'modules.common_msgs.sensor_msgs.smartereye_pb2'})
