...
InsStat = _reflection.GeneratedProtocolMessageType('InsStat', (_message.Message,), {'DESCRIPTOR': _INSSTAT, '__module__': 'modules.common_msgs.sensor_msgs.ins_pb2'})
_sym_db.RegisterMessage(InsStat)
Ins = _reflection.GeneratedProtocolMessageType('Ins', (_message.Message,), {'DESCRIPTOR': _INS, '__module__': 'modules.common_msgs.sensor_msgs.ins_pb2'})
