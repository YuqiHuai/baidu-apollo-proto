...
RadarObstacle = _reflection.GeneratedProtocolMessageType('RadarObstacle', (_message.Message,), {'DESCRIPTOR': _RADAROBSTACLE, '__module__': 'modules.common_msgs.sensor_msgs.radar_pb2'})
_sym_db.RegisterMessage(RadarObstacle)
RadarObstacles = _reflection.GeneratedProtocolMessageType('RadarObstacles', (_message.Message,), {'RadarObstacleEntry': _reflection.GeneratedProtocolMessageType('RadarObstacleEntry', (_message.Message,), {'DESCRIPTOR': _RADAROBSTACLES_RADAROBSTACLEENTRY, '__module__': 'modules.common_msgs.sensor_msgs.radar_pb2'}), 'DESCRIPTOR': _RADAROBSTACLES, '__module__': 'modules.common_msgs.sensor_msgs.radar_pb2'})
