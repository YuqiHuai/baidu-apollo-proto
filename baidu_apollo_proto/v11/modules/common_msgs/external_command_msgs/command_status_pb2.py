...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n>modules/common_msgs/external_command_msgs/command_status.proto\x12\x17apollo.external_command\x1a+modules/common_msgs/basic_msgs/header.proto"U\n\x14CommandStatusRequest\x12%\n\x06header\x18\x01 \x01(\x0b2\x15.apollo.common.Header\x12\x16\n\ncommand_id\x18\x02 \x01(\x03:\x02-1"\x9b\x01\n\rCommandStatus\x12%\n\x06header\x18\x01 \x01(\x0b2\x15.apollo.common.Header\x12\x16\n\ncommand_id\x18\x02 \x01(\x03:\x02-1\x12:\n\x06status\x18\x03 \x02(\x0e2*.apollo.external_command.CommandStatusType\x12\x0f\n\x07message\x18\x04 \x01(\t*F\n\x11CommandStatusType\x12\x0b\n\x07RUNNING\x10\x01\x12\x0c\n\x08FINISHED\x10\x02\x12\t\n\x05ERROR\x10\x03\x12\x0b\n\x07UNKNOWN\x10\x04')
...
CommandStatusRequest = _reflection.GeneratedProtocolMessageType('CommandStatusRequest', (_message.Message,), {'DESCRIPTOR': _COMMANDSTATUSREQUEST, '__module__': 'modules.common_msgs.external_command_msgs.command_status_pb2'})
_sym_db.RegisterMessage(CommandStatusRequest)
CommandStatus = _reflection.GeneratedProtocolMessageType('CommandStatus', (_message.Message,), {'DESCRIPTOR': _COMMANDSTATUS, '__module__': 'modules.common_msgs.external_command_msgs.command_status_pb2'})
