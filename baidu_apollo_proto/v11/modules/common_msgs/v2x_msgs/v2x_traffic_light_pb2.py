...
SingleTrafficLight = _reflection.GeneratedProtocolMessageType('SingleTrafficLight', (_message.Message,), {'DESCRIPTOR': _SINGLETRAFFICLIGHT, '__module__': 'modules.common_msgs.v2x_msgs.v2x_traffic_light_pb2'})
_sym_db.RegisterMessage(SingleTrafficLight)
RoadTrafficLight = _reflection.GeneratedProtocolMessageType('RoadTrafficLight', (_message.Message,), {'DESCRIPTOR': _ROADTRAFFICLIGHT, '__module__': 'modules.common_msgs.v2x_msgs.v2x_traffic_light_pb2'})
_sym_db.RegisterMessage(RoadTrafficLight)
IntersectionTrafficLightData = _reflection.GeneratedProtocolMessageType('IntersectionTrafficLightData', (_message.Message,), {'DESCRIPTOR': _INTERSECTIONTRAFFICLIGHTDATA, '__module__': 'modules.common_msgs.v2x_msgs.v2x_traffic_light_pb2'})
